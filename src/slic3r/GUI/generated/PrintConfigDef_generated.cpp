...
// DO NOT EDIT MANUALLY. Edit .proto files and re-run codegen.
    ...
    def = this->add("filament_z_hop", coFloats);
    ...
    def = this->add("filament_z_hop_types", coEnums);
    ...
    def->set_default_value(new ConfigOptionEnumsGenericNullable{ ZHopType::zhtSlope });

    def = this->add("filament_retract_lift_above", coFloats);
    ...
    def = this->add("filament_retract_lift_below", coFloats);
    ...
    def = this->add("filament_retract_lift_enforce", coEnums);
    ...
    def->set_default_value(new ConfigOptionEnumsGenericNullable{ RetractLiftEnforceType ::rletAllSurfaces });

    def = this->add("filament_retraction_speed", coFloats);
    ...
    def = this->add("filament_deretraction_speed", coFloats);
    ...
    def = this->add("filament_retract_restart_extra", coFloats);
    ...
    def = this->add("filament_retraction_minimum_travel", coFloats);
    ...
    def = this->add("filament_wipe_distance", coFloats);
    ...
    def = this->add("filament_retract_when_changing_layer", coBools);
    ...
    def = this->add("filament_wipe", coBools);
    ...
    def = this->add("filament_retract_before_wipe", coPercents);
    ...
    def = this->add("filament_long_retractions_when_cut", coBools);
    ...
    def = this->add("filament_retraction_distances_when_cut", coFloats);
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{500., 200.});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{1000., 1000.});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{10., 10.});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{12., 12.});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{0.2, 0.4});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{120., 120.});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{5000., 5000.});
    ...
    def->min = 0;
    def->mode = comSimple;
    def->set_default_value(new ConfigOptionFloats{2.5, 2.5});
